...
#'                  will be saved.
#' @param logo A character string specifying the logo for the application. Default is
#'             `"ohdsi"`.
...
#'
#' @export
shinyCharacteristics <- function(result, directory, logo = "ohdsi", theme = "bslib::bs_theme(bootswatch = 'flatly')") {
