...
test_that("dateRange argument works", {
  ...
  expect_equal(x |> dplyr::arrange(.data$variable_name, .data$variable_level, .data$estimate_name, .data$additional_level), y |> dplyr::arrange(.data$variable_name, .data$variable_level, .data$estimate_name, .data$additional_level), ignore_attr = TRUE)
  ...
  expect_equal(summariseClinicalRecords(cdm, "drug_exposure", dateRange = as.Date(c("2012-01-01", NA))) |> dplyr::arrange(.data$variable_name, .data$variable_level, .data$estimate_name, .data$additional_level), y |> dplyr::arrange(.data$variable_name, .data$variable_level, .data$estimate_name, .data$additional_level), ignore_attr = TRUE)
