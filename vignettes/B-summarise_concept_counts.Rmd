...
```{r, warning=FALSE}
summariseConceptCounts(cdm, conceptId = list("acetaminophen" = acetaminophen, "sinusitis" = sinusitis), countBy = c("record","person")) \|\> select(group_level, variable_name, estimate_name) \|\> distinct() \|\> arrange(group_level, variable_name)
...
```{r, warning=FALSE} 
summariseConceptCounts(cdm, conceptId = list("sinusitis" = sinusitis), countBy = "person") \|\> plotConceptCounts()
