...
First, let's generate a list of codes for the drug `acetaminophen` and condition `sinusitis` using [CodelistGenerator](https://darwin-eu.github.io/CodelistGenerator/index.html) package.
...
``` {r, warning=FALSE} 
summariseConceptCounts(cdm, conceptId = list("acetaminophen" = acetaminophen, "sinusitis" = sinusitis), countBy = "person", year = TRUE, sex = TRUE, ageGroup = list("<=50" = c(0, 50), ">50" = c(51, Inf))) |>
